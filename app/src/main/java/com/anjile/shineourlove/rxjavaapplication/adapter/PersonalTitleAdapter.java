...
public class PersonalTitleAdapter extends RecyclerView.Adapter<PersonalTitleAdapter.ArchitectureHolder> {

    private List<PersonalTitleBean> beanList;
    private Context context;
    private Activity activity;
    private String type;

    public PersonalTitleAdapter(List<PersonalTitleBean> companyList, Context context, Activity activity, String type) {
